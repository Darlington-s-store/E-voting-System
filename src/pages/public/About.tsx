...
const benefits = [
  { icon: ShieldCheck, title: "Eliminate fraud", desc: "Cryptographic integrity at every step." },
  {
    ...
    desc: "Mobile-first design lifts turnout 2-3×.",
  },
...
const timeline = [
  { year: "2022", title: "Platform founded", desc: "Built by election security experts." },
  {
    ...
    desc: "Universities across West Africa onboard.",
  },
  {
    year: "2024",
    title: "ISO 27001 certified",
    desc: "International security compliance achieved.",
  },
  {
    year: "2025",
    title: "Multi-region rollout",
    desc: "Now serving institutions in 12 countries.",
  },
  {
    year: "2026",
    title: "50,000+ active voters",
    desc: "Trusted with critical democratic decisions.",
  },
];
    ...
    <div className="max-w-6xl mx-auto px-6 py-16">
      <div className="text-center max-w-3xl mx-auto">
        ...
        <h1 className="mt-4 text-4xl md:text-5xl font-extrabold">
          Bringing democracy into the digital age
        </h1>
      </div>
      ...
      <div className="mt-12 rounded-2xl bg-gradient-to-br from-navy to-navy/90 text-white p-10 md:p-14 relative overflow-hidden">
        ...
        <p className="text-2xl md:text-3xl font-bold leading-snug">
          "Every vote deserves to be heard, counted, and protected. We exist to ensure no
          institution has to choose between security and accessibility."
        </p>
        ...
        {[
          {
            ...
            desc: "E-voting system was designed from the ground up for universities, churches, and associations that need rigorous election integrity without enterprise complexity. Every workflow is tuned for real institutional needs.",
            reverse: false,
          },
          {
            title: "Security at every layer",
            desc: "From end-to-end ballot encryption to per-action audit logging, our platform is engineered to withstand scrutiny. Independently audited, ISO 27001 certified.",
            reverse: true,
          },
          {
            title: "Accessible to everyone",
            desc: "WCAG 2.1 AA compliant, multilingual, and built mobile-first. Voters cast ballots from anywhere, on any device.",
            reverse: false,
          },
        ].map((s) => (
          <div
            key={s.title}
            className={`grid md:grid-cols-2 gap-10 items-center ${s.reverse ? "md:[&>*:first-child]:order-2" : ""}`}
          >
