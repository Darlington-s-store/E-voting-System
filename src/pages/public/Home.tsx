...
const features = [
  {
    ...
    desc: "End-to-end AES-256 encryption protects every ballot from creation to count.",
  },
  {
    icon: BarChart3,
    title: "Real-time results",
    desc: "Watch results update live as votes are cast, with rich visualizations.",
  },
  {
    icon: Smartphone,
    title: "Mobile voting",
    desc: "Voters cast ballots from any device — fully responsive and accessible.",
  },
  {
    icon: Shield,
    title: "Anti-fraud protection",
    desc: "Cryptographic receipts and device fingerprinting prevent duplicate votes.",
  },
  {
    icon: FileSearch,
    title: "Complete audit trail",
    desc: "Every action is logged immutably for full transparency and compliance.",
  },
  {
    icon: Layers,
    title: "Multi-election support",
    desc: "Run concurrent elections with isolated voter lists and configurations.",
  },
];
...
const steps = [
  {
    icon: UserPlus,
    title: "Register",
    desc: "Voters verify identity through institutional credentials and 2FA.",
  },
  {
    icon: VoteIcon,
    title: "Cast Vote",
    desc: "Securely cast ballots from any device in under 2 minutes.",
  },
  {
    icon: TrendingUp,
    title: "View Results",
    desc: "Real-time, tamper-proof results published instantly when elections close.",
  },
];
...
const testimonials = [
  ...
  },
  {
    ...
    quote: "We held our deaconship election entirely online. Effortless and incredibly secure.",
    role: "Parish Council",
    avatar: "GC",
  },
  {
    name: "GIMPA Alumni Assoc.",
    quote: "The audit trail and live results gave members complete confidence in the outcome.",
          ...
          <div>
            ...
            >
              ...
              <p className="mt-6 text-lg text-white/80 max-w-xl">
                The trusted digital voting platform for universities, churches, and associations.
                Run secure, tamper-proof elections in minutes.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center max-w-2xl mx-auto mb-14">
            ...
            <p className="mt-4 text-muted-foreground">
              A complete toolkit built with security, transparency, and accessibility at its core.
            </p>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {features.map((f) => (
              <div
                key={f.title}
                className="p-6 rounded-xl bg-card border border-border shadow-soft hover:shadow-lift hover:-translate-y-0.5 transition-all"
              >
              ...
              <div key={s.title} className="relative">
                <div className="bg-card rounded-xl p-7 border border-border shadow-soft">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <span className="text-3xl font-extrabold text-muted-foreground/40 font-mono">
                      0{i + 1}
                    </span>
                  </div>
                ...
                {i < 2 && (
                  <ArrowRight className="hidden md:block absolute top-1/2 -right-4 w-6 h-6 text-muted-foreground/50" />
                )}
              </div>
            ))}
          </div>
            ...
            {testimonials.map((t) => (
              <div key={t.name} className="p-7 rounded-xl bg-card border border-border shadow-soft">
                ...
                <div className="mt-5 flex items-center gap-3">
                  <div className="w-10 h-10 rounded-full gradient-brand text-white font-bold flex items-center justify-center text-sm">
                    {t.avatar}
                  </div>
                  <div>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="rounded-2xl gradient-navy text-white p-10 md:p-14 text-center relative overflow-hidden">
            ...
            <p className="relative mt-3 text-white/80 max-w-xl mx-auto">
              Join hundreds of institutions running secure, transparent digital elections.
            </p>
