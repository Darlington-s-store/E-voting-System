      ...
      <div className="hidden lg:flex relative gradient-navy text-white p-12 flex-col justify-between overflow-hidden">
        ...
        <div className="relative max-w-md">
          ...
          <p className="text-2xl font-semibold leading-snug">
            "Democracy is the art of building consensus. Our job is to make sure every voice counts
            — securely, fairly, and transparently."
          </p>
          <p className="mt-4 text-white/70 text-sm">The E-voting System Team</p>
        </div>
