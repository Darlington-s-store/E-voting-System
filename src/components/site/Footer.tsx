    ...
    <footer className="bg-navy text-white/80 mt-20">
        ...
        <div>
          ...
          <div className="flex gap-3">
            {[Twitter, Linkedin, Github, Mail].map((Icon, i) => (
              <a key={i} href="#" className="w-9 h-9 rounded-lg bg-white/10 hover:bg-white/20 flex items-center justify-center">
      ...
      <div className="border-t border-white/10">
        <div className="max-w-7xl mx-auto px-6 py-5 text-sm text-white/50 flex flex-col md:flex-row justify-between gap-2">
          <span>© 2026 SecureVote Pro. All rights reserved.</span>
