      ...
      {open && (
        <div className="md:hidden bg-card border-t border-border px-4 py-4 space-y-2">
          ...
          <div className="pt-2 flex gap-2">
            <Link to="/login" className="flex-1"><Button variant="outline" className="w-full">Admin</Button></Link>
            <Link to="/login" className="flex-1"><Button className="w-full bg-brand text-white">Voter Login</Button></Link>
          </div>
        </div>
      )}
    </header>
